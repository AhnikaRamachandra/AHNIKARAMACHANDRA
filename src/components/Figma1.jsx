...
<div className="flex justify-between items-center">
  ...
  <div className="text-gray-300 border-l-8 border-[#5F9448] ml-20 pl-6 inline-block">
    <h4 className="text-5xl mb-6">Let's</h4>
    <h4 className="text-5xl mb-6">Cook with</h4>
    <h1 className="text-6xl">Bitecraft</h1>
  </div>
...
<div className="flex items-center gap-4 pl-8">
  <span className="w-3 h-3 bg-[#5F9448] rounded-full"></span>
  <h1 className="text-[#5F9448] text-3xl md:text-4xl font-bold">
    Home Screen
  </h1>
</div>
...
<div>
  <h4 className='mt-10 text-2xl px-8 leading-relaxed text-[#D9D9D9]'>The Search Screen lets users find recipes by typing a recipe name or using filters for cuisine, cooking time, difficulty, or dietary preferences, ensuring quick and relevant results.</h4>
...
<div>
  ...
  <img className=" mt-[-80px] w-full" src={chef} alt="bitecraft" />
  
</div>   

<div className="flex mt-[-20px] items-center gap-4 pl-8">
  <span className="w-3 h-3 bg-[#5F9448] rounded-full"></span>
  <h1 className="text-[#5F9448] text-3xl md:text-4xl font-bold">
   Your Account
  </h1>
...
<div className="flex mt-[-20px] items-center gap-4 pl-8">
 ...
 <img className="mt-16  w-full" src={wire} alt="bitecraft" />

 <div className="flex mt-20 items-center gap-4 pl-8">
  <span className="w-3 h-3 bg-[#5F9448] rounded-full"></span>
  <h1 className="text-[#5F9448] text-3xl md:text-4xl font-bold">
   Moodboard
  </h1>
